...
import { getJob, saveResume, dismissJob, restoreJob, markApplied, markStatus, resumeUrl, coverUrl } from "@/lib/api";
          ...
          {!loading && job && activeTab === "resume" && (
            <div className="p-5">
              {job.resume_text ? (
                ...
                <p className="text-sm text-void-muted italic">No tailored resume yet.</p>
              )}
            </div>
          )}
          ...
          {!loading && job && activeTab === "cover" && (
            <div className="p-5">
              {job.cover_letter_text ? (
                ...
                <p className="text-sm text-void-muted italic">No cover letter yet.</p>
              )}
            </div>
          )}
        </div>
