  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
        <path
          fillRule="evenodd"
          d="M6.672 1.911a1 1 0 1 0-1.932.518l.259.966a1 1 0 0 0 1.932-.518l-.26-.966ZM2.429 4.74a1 1 0 1 0-.518 1.932l.966.259a1 1 0 0 0 .518-1.932l-.966-.26Zm8.814-.569a1 1 0 0 0-1.415-1.414l-.707.707a1 1 0 1 0 1.415 1.414l.707-.707Zm-7.071 7.072 1.414-1.415a1 1 0 1 0-1.414-1.414l-1.414 1.414a1 1 0 1 0 1.414 1.415ZM16.894 4.1a1 1 0 0 0-1.788.894l.464 .928a1 1 0 0 0 1.788-.894l-.464-.928ZM10 11a1 1 0 0 1 1 1v3a1 1 0 1 1-2 0v-3a1 1 0 0 1 1-1Zm4-1a1 1 0 0 1 1 1v4a1 1 0 1 1-2 0v-4a1 1 0 0 1 1-1Zm-8 2a1 1 0 0 1 1 1v2a1 1 0 1 1-2 0v-2a1 1 0 0 1 1-1Z"
          clipRule="evenodd"
        />
      </svg>
    ),
